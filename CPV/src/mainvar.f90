  ...
  CONTAINS
    ...
    SUBROUTINE allocate_mainvar( ngw, ngw_g, ngb, ngs, ng, nr1, nr2, nr3, &
      ...
      IF ( dft_is_meta() ) THEN
         ...
         ALLOCATE( kedtaus_tau_store( nrxxs, nspin ) ) !HK/MCA
         !
      ELSE
         !
         ...
         ALLOCATE( kedtaus_tau_store( 1, nspin ) ) !HK/MCA
         !
      END IF
      !
...
!==========================================================================
    ...
    SUBROUTINE deallocate_mainvar()
      ...
      IF( ALLOCATED( kedtaus_tau_store ) ) DEALLOCATE( kedtaus_tau_store ) !HK/MCA
