...
subroutine tpsscxc( rho, grho, tau, sx, sc, v1x, v2x, v3x, v1c, v2c, v3c )
...
#ifdef __LIBXC
  !MCA:HK LIBXC and CP version were tested with H2 molecule. 
  !    They both gave consistent result with ORCA
  ...
  sx  = sx * rho
  v2x = v2x * 2.D0 ! MCA/HK: for CP compatibility
  ...
  sc  = sc * rho
  v2c = v2c * 2.D0 ! MCA/HK: for CP compatibility
...
subroutine scancxc( rho, grho, tau, sx, sc, v1x, v2x, v3x, v1c, v2c, v3c )
  ...
  sx  = sx * rho
  v2x = v2x * 2.D0 ! MCA/HK: for CP compatibility : inherit from TPSS (still need to understand why)

  ! correlation
  func_id = 267  ! Perdew, Tao, Staroverov & Scuseria correlation  
  call xc_f90_func_init(xc_func, xc_info, func_id, XC_UNPOLARIZED)   
  call xc_f90_mgga_exc_vxc(xc_func,size , rho, grho, lapl_rho, tau,&
                               sc, v1c, v2c, vlapl_rho, v3c)  
  call xc_f90_func_end(xc_func)
...
subroutine scanxc_spin( rhoup, rhodw, grhoup, grhodw, tauup, taudw, &
  ...
  call xc_f90_func_end(xc_func)
  !
  !MCA/HK: from libxc to QE format
  !
  sx  = sx * ( rho(1) + rho(2) )
  v1xup = v1x(1)
  v2xup = v2x(1) * 2.D0
  ...
  v3cdw = v3c(2)
  !
  !MCA/HK: cross terms of v2c(2). v2x(2) is always zero.
  !
  do ipol = 1,3
  !
...
subroutine scancxc_array_spin(nnr, rho, grho2, tau, sx, sc, v1x, v2x, v3x, v1c, v2c, v3c )
  ...
  lapl_rho = 0.D0 !MCA/HK: not used in SCAN
  ...
  !
  call xc_f90_func_init(xc_func, xc_info, func_id, XC_POLARIZED)    
  !call xc_f90_mgga_exc_vxc(xc_func, nnr, rho(1,1), grho2(1,1), lapl_rho(1,1,1), tau(1,1),&
  !  &                      sx(1), v1x(1,1), v2x(1,1), vlapl_rho(1,1,1), v3x(1,1))  
  call xc_f90_mgga_exc_vxc(xc_func, nnr, rho(1,1), grho2(1,1), lapl_rho(1,1,1), tau(1,1),&
    &                      sx(1), v1x(1,1), v2x(1,1), vlapl_rho(1,1,1), v3x(1,1))  
  call xc_f90_func_end(xc_func)
  ! 
  ...
  call xc_f90_func_init(xc_func, xc_info, func_id, XC_POLARIZED)   
  call xc_f90_mgga_exc_vxc(xc_func, nnr, rho(1,1), grho2(1,1), lapl_rho(1,1,1), tau(1,1),&
    &                      sc(1), v1c(1,1), v2c(1,1), vlapl_rho(1,1,1), v3c(1,1))  
  call xc_f90_func_end(xc_func)
  !
  sc  = sc * ( rho(1,:) + rho(2,:) )
  v2c = v2c * 2.D0 ! MCA/HK: for CP compatibility
